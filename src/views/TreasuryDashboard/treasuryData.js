...
export const tooltipInfoMessages = {
  tvl: "Total Value Deposited, is the dollar amount of all TEMPO staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.",
  mvt: "Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.",
  rfv: "Risk Free Value, is the amount of funds the treasury guarantees to use for backing TEMPO.",
  ...
  holder: "Holders, represents the total number of Ohmies (sTEMPO holders)",
  staked: "TEMPO Staked, is the ratio of sTEMPO to TEMPO (staked vs unstaked)",
  ...
  runway: "Runway, is the number of days sTEMPO emissions can be sustained at a given rate. Lower APY = longer runway",
};
